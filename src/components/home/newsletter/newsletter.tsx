...
export const Newsletter: FC = () => {
  ...
  return (
    <div className="gap-8 md:gap-0 px-4 grid md:grid-cols-2 md:items-center justify-center container mx-auto w-full overflow-hidden bg-rose-50 min-h-[500px] font-roboto mt-10 lg:mt-20">
      {/* Image */}
      ...
      <div className="space-y-6 text-center md:text-left">
        <h2 className="text-4xl font-bold tracking-tight md:text-5xl text-center">
          Stay Glowing with <span className="text-rose-500">NIVIORA</span>
        </h2>
